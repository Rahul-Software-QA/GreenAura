...
public class ExternalProduct {
    ...
    public void testProductQuantity() {
        try {
            ...
            WebElement ExternalProductButton = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//ul[@class='quadmenu-row ps-container ps-theme-default']//li[@id='menu-item-1229']//div[@id='dropdown-1229']//ul//li[@id='menu-item-1244']//a")));
            ExternalProductButton.click();
            System.out.println("Navigated to 'Extenal Product' page.");
            
            WebElement addToCartButton = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[normalize-space()='Buy Product']")));
