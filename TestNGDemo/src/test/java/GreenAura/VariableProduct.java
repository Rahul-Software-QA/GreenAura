...
public class VariableProduct {
    ...
    public void testProductQuantity() {
        try {
            ...
            WebElement variableProductButton = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//ul[@class='quadmenu-row ps-container ps-theme-default']//li[@id='menu-item-1229']//div[@id='dropdown-1229']//ul//span[@class='quadmenu-text quadmenu_pulse hover t_1000'][normalize-space()='Product Variable']")));
            variableProductButton.click();
            System.out.println("Navigated to 'Product Variable' page.");
            
            WebElement shadeButton = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//select[@id='shade']")));
            shadeButton.click();
            System.out.println("Navigated to 'choose an option' shade.");
            
            
            WebElement clearButton = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[@class='reset_variations']")));
            clearButton.click();
            System.out.println("Navigated to 'clear' shade.");
